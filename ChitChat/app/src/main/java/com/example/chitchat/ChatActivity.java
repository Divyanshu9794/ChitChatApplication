...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseUtil.getOtherProfilePicStorageRef(otherUser.getUserId()).getDownloadUrl()
                .addOnCompleteListener(t -> {
                    if(t.isSuccessful()){
                        Uri uri =t.getResult();
                        AndroidUtil.setProfilePick(this,uri,imageView);
                    }
                });
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAxCMFYP4:APA91bEYfE9Hx5SUyq88gPrzHD47T_-LVgNHNgDYfb7fFlIkmQ5Bjmwm5rGr7XwkR_M6FriNhgKB4_iJt3UtPT3Y60ckVa0Nf9m7XHaHDQB8fZ-PIj9Rd367RATIwjaERRB8u80K32_A")
                .build();
